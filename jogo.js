...
function mostrarAngulo(){
    mostrarIndicador(`Ângulo: ${(moduloLunar.angulo * 180 / Math.PI).toFixed(0)}°`, 400, 40)
...
function mostrarAltitude(){
    mostrarIndicador(`Altitude: ${(canvas.height - moduloLunar.posicao.y -
                                    0.5 * moduloLunar.altura).toFixed(0)}`, 400, 60)
...
function mostrarAngulo(){
    mostrarIndicador(mensagem= `Ângulo: ${(moduloLunar.angulo * 180 / Math.PI).toFixed(0)}°`,
    x= 400, y=40);
...
function mostrarVelocidadeHorizontal(){
    mostrarIndicador(`Velocidade Horizontal: ${(10 * moduloLunar.velocidade.x).toFixed(2)}`, 130, 40)
...
function mostrarVelocidadeVertical(){
    mostrarIndicador(`Velocidade Vertical: ${(10 * moduloLunar.velocidade.y).toFixed(2)}`, 120, 60)
...
function mostrarCombustivel(){
    mostrarIndicador(`Combustível: ${(moduloLunar.combustivel / 10).toFixed(0)} %`,120 , 80)
...
function mostrarResultado(mensagem, cor){
    contexto.font = "bold 80px Calibri";
...
function mostrarIndicador(mensagem, x, y){
    contexto.font = "bold 20px Calibri";
    contexto.textAlign = "center";
    contexto.textBaseline = "middle";
    contexto.fillStyle = moduloLunar.cor;
